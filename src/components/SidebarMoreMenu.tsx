...
export function SidebarMoreMenu({
  editing, hiddenItems, onDoneEditing, onStartEditing, onAdd, onAddDivider, onNavigate, open, onOpenChange, compact,
    ...
    return (
      <div className="flex flex-col gap-0.5">
        <DropdownMenu open={addMenuOpen} onOpenChange={(o) => { setAddMenuOpen(o); if (!o) setAddQuery(''); }}>
          ...
          <DropdownMenuContent side="top" align="start" avoidCollisions={false} collisionPadding={8} className="w-[240px] p-1 pb-[calc(0.25rem+env(safe-area-inset-bottom,0px))] flex flex-col max-h-[calc(var(--radix-dropdown-menu-content-available-height)-12px)]">
