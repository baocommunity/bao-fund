...
const settingsSections: SettingsSection[] = [
  ...
  },
  {
    id: 'wallet',
    label: 'Wallet',
    description: 'Cashu wallet, zaps, and payment settings',
    ...
    <main className="relative min-h-screen pb-16 sidebar:pb-0">
      ...
      <div className="px-7 pb-4 pt-4 text-center space-y-2.5">
        <p className="text-xs text-muted-foreground leading-relaxed select-none">
          Shape your identity, manage your wallet, and tune how you connect to the Nostr network.<br />Everything you need to make this place feel like yours.
        </p>
