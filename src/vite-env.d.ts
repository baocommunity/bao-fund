...
interface ImportMetaEnv {
   ...
   * remote-login callbacks, etc). Overridden by `shareOrigin` in `app.json`
  ...
  /** Build-time configuration injected from app.json as a JSON string. `"null"` when no config file was provided. */
